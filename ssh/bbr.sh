...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/yardproject/hele/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/yardproject/hele/main/ip | grep $MYIP | awk '{print $2}')
